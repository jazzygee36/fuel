  ...
  const pickPassport = async () => {
    try {
      ...
      if (!result.canceled && result.assets.length > 0) {
        ...
        // Save image in parent component
    ...
    <View style={styles.container}>
      ...
      <Pressable
        style={[
          ...
          frontImage && styles.selectedContainer,
        ]}
        ...
        {frontImage ? (
          ...
          <>
            ...
            <Text style={styles.uploadDescription}>
              Tap here to select a photo of your passport
            </Text>
          </>
        )}
      </Pressable>
        ...
        <AppButton
          ...
          onPress={() => {
            if (!frontImage) {
              Alert.alert(
                "Passport required",
                "Please upload your passport before continuing.",
              );
              return;
            }
